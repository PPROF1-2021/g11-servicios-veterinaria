...
$constatacion=("select * from usuario where correo_electronico='$correo_formu' and contrasena='$contrasena_formu' and fecha_de_baja='$fecha_baja_formu'");
...
if ($num>0) {
        ...
        echo"No escontramos su registración compruebe los datos";
	}
 mysqli_close($con);
